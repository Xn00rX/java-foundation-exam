...
public class SalaryUtils {
    ...
    public static double calculateTax(double annualSalary) {
        ...
        if (annualSalary< 0){
            throw new IllegalArgumentException("Annual Salary is Negative");
        }
    ...
    public static double applyRaise(double currentSalary, double percentRaise) {
        // TODO: Implement this method
        if (currentSalary< 0){
            throw new IllegalArgumentException("Current Salary is Negative");
        }

        if (percentRaise < 0 || percentRaise > 100){
            throw new IllegalArgumentException("Percent Raise is Negative or Above 100");
        }
